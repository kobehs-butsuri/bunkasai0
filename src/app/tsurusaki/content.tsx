...
export default function Content() {
    ...
    return (
        <div ref={containerRef} className="min-h-[calc(100dvh-100px)] pt-20 relative bg-background">
            ...
            >
                <div className="pl-6 md:pl-10">
                    <p className="text-xl md:text-3xl lg:text-4xl text-primary leading-relaxed font-bold tracking-wide">
